...
public class RangeSeekBar<T extends Number> extends ImageView
{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            internalPad = Utils.dpToPx(context, INITIAL_PADDING_IN_DP);
        ...
        textSize = Utils.dpToPx(context, DEFAULT_TEXT_SIZE_IN_DP);
        distanceToTop = Utils.dpToPx(context, DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP);
        textOffset = !showTextAboveThumbs ? 0 : this.textSize + Utils.dpToPx(context,
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = thumbImage.getHeight()
                + (!showTextAboveThumbs ? 0 : Utils.dpToPx(getContext(), HEIGHT_IN_DP))
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            if (!singleThumb) {
                ...
                int spacing = Utils.dpToPx(getContext(), TEXT_LATERAL_PADDING_IN_DP);
